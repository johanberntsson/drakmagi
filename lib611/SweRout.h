...
! had to be increased to four genders in order to make Inform understand Swedish.
!
...
! 1st person.
!
! CantSee needed a fix to stop "ta på mig jkjkl" -> "You can't see me(yourself) here."
!
...
! ¤#¤ Added one line
      else if(i==player) print "mig själv";
